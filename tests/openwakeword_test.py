if __name__ == '__main__':
    ...
    with AudioToTextRecorder(
        ...
        openwakeword_model_paths="tests/suh_man_tuh.onnx,tests/suh_mahn_thuh.onnx", # load these test models from https://huggingface.co/KoljaB/SamanthaOpenwakeword/tree/main and save in tests folder
